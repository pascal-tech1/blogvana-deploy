	...
	return (
		...
		>
			...
			<div className=" w-full lg:max-w-[50rem] overflow-y-auto">
				...
				<div class="flex items-center w-full justify-center h-48 mb-4 bg-gray-300 rounded dark:bg-gray-700">
					<svg
				...
				<div  className=" flex flex-col gap-2 w-full">
					<div className=" w-full">
						...
						<div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-4 mr-4"></div>

						<div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-4"></div>
						<div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-4 mr-6"></div>
					</div>
